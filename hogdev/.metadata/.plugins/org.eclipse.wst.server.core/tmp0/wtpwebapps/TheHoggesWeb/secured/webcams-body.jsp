...
<span id="wc1">
	<html:img imageName="webcam2" alt="Web Camera #2" page="/webcams/camera1.jpg?time=0" width="330"/>
</span>
<span id="wc2">
	<html:img imageName="webcam2" alt="Web Camera #2" page="/webcams/camera2.jpg?time=0" width="330"/>
</span>
<span id="wc3">
	<html:img imageName="webcam2" alt="Web Camera #2" page="/webcams/camera3.jpg?time=0" width="330"/>
</span>
